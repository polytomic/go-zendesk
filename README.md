...
To authenticate using OAuth, simply use the excellent
[x/oauth2](https://pkg.go.dev/golang.org/x/oauth2) package to [create an HTTP
client](https://pkg.go.dev/golang.org/x/oauth2#Config.Client) and pass it to the
`NewClient`.
